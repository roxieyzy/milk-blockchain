...
<!--    </el-dialog>-->
    ...
    <el-dialog
      ...
      <el-form label-width="100px" :rules="rules" :model="editForm">
        <el-form-item label="运输负责人" prop="tperson">
          <el-input v-model="editForm.tperson"></el-input>
        </el-form-item>
        <el-form-item label="出发地" prop="tbeginaddress">
          <el-input v-model="editForm.tbeginaddress"></el-input>
        </el-form-item>
        <el-form-item label="目的地" prop="tarriveaddress">
          <el-input v-model="editForm.tarriveaddress"></el-input>
        </el-form-item>
      </el-form>
      <span slot="footer" class="dialog-footer">
