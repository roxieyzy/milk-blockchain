  ...
  <div class="roles">
    ...
    <div class="sys-research">
      <el-row class="row-search">
        <el-col :span="1">
          <el-button plain @click="customerDialogVisible = true">添加运输商</el-button>
        </el-col>
      </el-row>
    </div>
    <!-- start 添加角色弹窗 -->
    <el-dialog
      ...
      <el-form label-width="100px" :model="addForm" :rules="rules" class="demo-ruleForm"  ref="addaddFormRef">
        <el-form-item label="运输商" prop="tname">
          <el-input v-model="addForm.tname"></el-input>
        </el-form-item>
        <el-form-item label="账户" prop="taccount">
          <el-input v-model="addForm.taccount"></el-input>
        </el-form-item>
        <el-form-item label="密码" prop="tpassword">
          <el-input v-model="addForm.tpassword"></el-input>
        </el-form-item>
        <el-form-item label="邮箱" prop="temail">
          <el-input v-model="addForm.temail"></el-input>
        </el-form-item>
        <el-form-item label="注册时间" prop="ttime">
          <el-date-picker
    ...
    <el-dialog
      ...
      <el-form label-width="100px" :rules="rules" :model="editForm">
        <el-form-item label="密码" prop="tpassword">
          <el-input v-model="editForm.tpassword"></el-input>
        </el-form-item>
        <el-form-item label="邮箱" prop="temail">
          <el-input v-model="editForm.temail"></el-input>
        </el-form-item>
      </el-form>
      <span slot="footer" class="dialog-footer">
    ...
    <el-table :data="FormList.slice((currentPage-1)*pageSize,currentPage*pageSize)"
      ...
      <el-table-column prop="tname" label="运输商"  align="center"></el-table-column>
      <el-table-column prop="taccount" label="账户"  align="center"></el-table-column>
      <el-table-column prop="temail" label="邮箱"  align="center"></el-table-column>
      <el-table-column prop="ttime" label="注册时间"  align="center"></el-table-column>
            <el-table-column label="操作" align="center">
              <template slot-scope="scope">
                <el-button size="mini" plain type="primary" icon="el-icon-edit"
                           @click="handleeditData(scope.$index, scope.row)">编辑
                </el-button>
                <el-button size="mini" plain type="danger" icon="el-icon-delete" @click="deleteThis(scope.row.tid)">删除
                </el-button>
...
export default {
  ...
  methods: {
    ...
    searchList () {
      var _this = this
      axios.post('/restful/traceSport/queryAllUser',
        {
    ...
    add() {
      var _this = this
      axios.post('restful/traceSport/insertOneUser',
        _this.addForm,
        {
          headers: {
            'content-type': 'application/json'
    ...
    editData () {
      var _this = this
      axios.post('restful/traceSport/updateUserInfo', _this.editForm,
        {
          headers: {
            'content-type': 'application/json'
          },
    ...
    async deleteThis (id) {
      ...
      try {
        ...
        axios.post('restful/traceSport/deleteOneUser', {'tid': id},
          {
            headers: {
              'content-type': 'application/json'
            },
