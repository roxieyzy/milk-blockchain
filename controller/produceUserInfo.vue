  ...
  <div class="roles">
    ...
    <el-dialog
      ...
      <el-form label-width="100px" :model="addForm" :rules="rules" class="demo-ruleForm"  ref="addaddFormRef">
        ...
        <el-form-item label="账户" prop="paccount">
          <el-input v-model="addForm.paccount"></el-input>
        </el-form-item>
        <el-form-item label="密码" prop="ppassword">
          <el-input v-model="addForm.ppassword"></el-input>
        </el-form-item>
    ...
    <el-dialog
      ...
      <el-form label-width="100px" :rules="rules" :model="editForm">
        <el-form-item label="密码" prop="ppassword">
          <el-input v-model="editForm.ppassword"></el-input>
        </el-form-item>
        <el-form-item label="邮箱" prop="pemail">
    ...
    <el-table :data="FormList.slice((currentPage-1)*pageSize,currentPage*pageSize)"
      ...
      <el-table-column prop="pname" label="生产商"  align="center"></el-table-column>
      <el-table-column prop="paccount" label="账户"  align="center"></el-table-column>
      <el-table-column prop="pemail" label="邮箱"  align="center"></el-table-column>
      <el-table-column prop="ptime" label="注册时间"  align="center"></el-table-column>
            <el-table-column label="操作" align="center">
              <template slot-scope="scope">
                <el-button size="mini" plain type="primary" icon="el-icon-edit"
                           @click="handleeditData(scope.$index, scope.row)">编辑
                </el-button>
                <el-button size="mini" plain type="danger" icon="el-icon-delete" @click="deleteThis(scope.row.pid)">删除
                </el-button>
...
export default {
  ...
  methods: {
    ...
    searchList () {
      var _this = this
      axios.post('/restful/produce/queryAllUser',
        {
    ...
    add() {
      var _this = this
      axios.post('restful/produce/insertOneUser',
        _this.addForm,
        {
          headers: {
            'content-type': 'application/json'
    ...
    editData () {
      var _this = this
      axios.post('restful/produce/updateUserInfo', _this.editForm,
        {
          headers: {
            'content-type': 'application/json'
          },
    ...
    async deleteThis (id) {
      ...
      try {
        ...
        axios.post('restful/produce/deleteOneUser', {'pid': id},
          {
            headers: {
              'content-type': 'application/json'
            },
