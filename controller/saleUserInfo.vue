  ...
  <div class="roles">
    ...
    <div class="sys-research">
      <el-row class="row-search">
        <el-col :span="1">
          <el-button plain @click="customerDialogVisible = true">添加销售商</el-button>
        </el-col>
      </el-row>
    </div>
    <!-- start 添加角色弹窗 -->
    <el-dialog
      ...
      <el-form label-width="100px" :model="addForm" :rules="rules" class="demo-ruleForm"  ref="addaddFormRef">
        <el-form-item label="销售商" prop="sname">
          <el-input v-model="addForm.sname"></el-input>
        </el-form-item>
        <el-form-item label="账户" prop="saccount">
          <el-input v-model="addForm.saccount"></el-input>
        </el-form-item>
        <el-form-item label="密码" prop="spassword">
          <el-input v-model="addForm.spassword"></el-input>
        </el-form-item>
        <el-form-item label="邮箱" prop="semail">
          <el-input v-model="addForm.semail"></el-input>
        </el-form-item>
        <el-form-item label="注册时间" prop="stime">
          <el-date-picker
            v-model="addForm.stime"
            type="date"
            placeholder="选择日期">
          </el-date-picker>
        </el-form-item>
    ...
    <el-dialog
      ...
      <el-form label-width="100px" :rules="rules" :model="editForm">
        <el-form-item label="密码" prop="spassword">
          <el-input v-model="editForm.spassword"></el-input>
        </el-form-item>
        <el-form-item label="邮箱" prop="semail">
          <el-input v-model="editForm.semail"></el-input>
        </el-form-item>
      </el-form>
      <span slot="footer" class="dialog-footer">
    ...
    <el-table :data="FormList.slice((currentPage-1)*pageSize,currentPage*pageSize)"
      ...
      <el-table-column prop="sname" label="销售商"  align="center"></el-table-column>
      <el-table-column prop="saccount" label="账户"  align="center"></el-table-column>
      <el-table-column prop="semail" label="邮箱"  align="center"></el-table-column>
      <el-table-column prop="stime" label="注册时间"  align="center"></el-table-column>
            <el-table-column label="操作" align="center">
              <template slot-scope="scope">
                <el-button size="mini" plain type="primary" icon="el-icon-edit"
                           @click="handleeditData(scope.$index, scope.row)">编辑
                </el-button>
                <el-button size="mini" plain type="danger" icon="el-icon-delete" @click="deleteThis(scope.row.sid)">删除
                </el-button>
...
export default {
  ...
  methods: {
    ...
    searchList () {
      var _this = this
      axios.post('/restful/sale/queryAllUser',
        {
    ...
    add() {
      var _this = this
      axios.post('restful/sale/insertOneUser',
        _this.addForm,
        {
          headers: {
            'content-type': 'application/json'
    ...
    editData () {
      var _this = this
      axios.post('restful/sale/updateUserInfo', _this.editForm,
        {
          headers: {
            'content-type': 'application/json'
          },
    ...
    async deleteThis (id) {
      ...
      try {
        ...
        axios.post('restful/sale/deleteOneUser', {'sid': id},
          {
            headers: {
              'content-type': 'application/json'
            },
